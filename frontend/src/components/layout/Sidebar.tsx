  ...
  return (
    <>
      ...
      <aside className="hidden w-64 shrink-0 flex-col border-r bg-sidebar md:flex">
        <div className="flex h-14 items-center border-b px-4 text-sm font-semibold tracking-tight">OpenSlop</div>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 flex md:hidden">
          <button type="button" aria-label="Close menu" onClick={onMobileClose} className="flex-1 bg-black/40" />
          <aside className="flex w-64 shrink-0 flex-col border-l bg-sidebar">
            <div className="flex h-14 items-center border-b px-4 text-sm font-semibold">OpenSlop</div>
